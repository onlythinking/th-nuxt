...
export default defineConfig<Theme>({
  theme: {
    ...
    spacing: {
      xs: '4px', // 极小的间距，适合小按钮或图标内边距
      sm: '8px', // 小间距，用于小型组件或列表项
      md: '12px', // 中等间距，适合常见的卡片、内容分区
      lg: '16px', // 较大间距，用于主内容区域分隔
      xl: '24px', // 超大间距，适合页面大块留白和边距
    },
  },
  presets: [
    presetUno(),
  ...
  shortcuts: [
    ...
    ['th-title', 'text-md font-500 leading-normal  leading-[1.4]'],
